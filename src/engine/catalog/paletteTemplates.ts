...
export const PALETTE_TEMPLATES: Record<string, PaletteTemplate> = {
  ...
  'rate-limiter': {
    ...
    profile: 'control-plane',
    rendererType: 'serviceNode',
    iconKey: 'rate-limiter',
    label: 'Rate Limiter',
    subLabel: 'Token Bucket Guard',
    serializable: true,
    seed: { throughput: 6000, load: 10, queueDepth: 4 }
  },
  'circuit-breaker-controller': {
    id: 'circuit-breaker-controller',
    componentType: 'circuit-breaker-controller',
    category: 'auxiliary',
    structuralRole: 'processor',
    profile: 'control-plane',
    rendererType: 'serviceNode',
    iconKey: 'circuit-breaker-controller',
    label: 'Circuit Breaker',
    subLabel: 'Fail-Fast Guard',
    serializable: true,
    seed: { throughput: 4000, load: 8, queueDepth: 2 }
  },
  'distributed-lock': {
    id: 'distributed-lock',
    ...
    profile: 'control-plane',
    rendererType: 'serviceNode',
    iconKey: 'distributed-lock',
    label: 'Distributed Lock',
    subLabel: 'Lease / Mutual Exclusion',
    serializable: true,
    seed: { throughput: 2500, load: 12, queueDepth: 6 }
  },
  'idempotency-manager': {
    id: 'idempotency-manager',
  ...
  'reservation-store': {
    ...
    componentType: 'reservation-store',
    category: 'auxiliary',
    structuralRole: 'processor',
    profile: 'control-plane',
    rendererType: 'serviceNode',
    iconKey: 'reservation-store',
    label: 'Reservation Store',
    subLabel: 'Atomic Seat Reserve',
    serializable: true,
    seed: { throughput: 4000, load: 10, queueDepth: 2 }
  },
